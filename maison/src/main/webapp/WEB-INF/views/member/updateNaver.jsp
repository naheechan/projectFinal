...
<jsp:include page="/WEB-INF/views/common/menuTitle.jsp">
	<jsp:param name="menuTitle" value="마이페이지 / 회원정보변경"/>
</jsp:include>
<style>
...
<section>
	<div class="update-box">
		...
		<br>
			<div class="row">
				<div class="col-lg-12">
					<form action="${path }/member/updateEndEnd.do" method="POST" onsubmit="return checkSubmit();">
							<div id="enroll-container" class="container">
								...
								<input type="hidden" id="email" name="email" value="<%=dEmail %>">
								<input type="hidden" id="gender" name="gender" value="${loginMember.gender}">
						
								<!-- 주소부분 -->
							 	<div class="form-group" id="address-container">
								    <label>주소</label><br>
								 	<input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="우편번호" required value="<%=dZipcode%>">
									<input type="button" class="btn" onclick="findZipCode()" id="zipcodeBtn" value="우편번호 찾기"><br>
									<input type="text" class="form-control" id="address" name="address" placeholder="주소" required value="<%=dAddress%>"><br>
									<input type="text" class="form-control" id="detailAddress" name="detailAddress" placeholder="상세주소" required value="<%=dDetailAddress%>">
							 	...
							 	<div class="form-group">
								    ...
								    <input type="text" class="form-control" id="datepicker" name="birth" required value="${loginMember.birth }">
								    <div id="checkBrith-container">
									    <p class="text-danger" id="notRegBrith" style="display:none">달력에서 생년월일을 선택해주세요</p>
								    </div>
								    <input type="hidden" id="brithCheck" name="brithCheck" value="1">
							 	</div>	
							 	
							 	<div class="form-group">
								    <label for="phone">전화번호</label><br>
								    <input type="text" class="form-control" id="phone" placeholder="'-'없이 숫자만 입력" name="phone" required value="<%=dPhone%>">
								    <div id="checkPhone-container">
									    <p class="text-danger" id="notRegPhone" style="display:none">전화번호를 '-'없이 숫자만 입력해주세요.</p>
								    </div>
								    <input type="hidden" id="phoneCheck" name="phoneCheck" value="1">
							 	</div>	
							 	...
							 	<div id="agreeEmail">
							 		...
							 		<div class="form-check">
									  <label class="form-check-label">
									    <input type="checkbox" class="form-check-input" name="emailStatus" value="Y" ${loginMember.emailStatus eq 'Y' ? 'checked' : '' }>주기알람 서비스 동의하기
									  </label>
									</div>
							 	</div>
