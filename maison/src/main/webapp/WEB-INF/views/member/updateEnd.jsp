						...
						<div id="enroll-container" class="container">
							...
							<div class="form-group">
						 	...
						 	<div class="form-group">
							    ...
							    <input type="hidden" id="nameCheck" name="nameCheck" value="1">
						 	</div>
<!-- 						 	<div class="form-group">
						 	...
						 	<div class="form-check-inline">
							  <label class="form-check-label">
							    ...
							    ${loginMember.gender eq "M" ? "checked" : ''}>남
							  </label>
							</div>
							<div class="form-check-inline">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="gender" value="F"
							    ${loginMember.gender eq "F" ? "checked" : ''}>여
							  </label>
							</div>
							<div class="form-check-inline disabled">
							  <label class="form-check-label">
							    <input type="radio" class="form-check-input" name="gender" value="U"
							    ${loginMember.gender eq "U" ? "checked" : ''}>공개안함
							  </label>
							</div>
