		              ...
		              <div class="d-flex justify-content-between flex-wrap">
		                ...
		                <div class="d-flex justify-content-between align-items-end flex-wrap">
		                  <div class="d-flex">
		                    ...
		                    <p class="text-primary mb-0 hover-cursor">함께해요 게시판 댓글 관리</p>
		                  </div>
		                </div>
		              </div>
		            </div>
...
function updateBtn(num){
	...
	openWin= window.open('${path }/admin/withCommentUpdate.do?num='+num,'댓글 수정하기','width=440,height=320,scrollbars=no,left=200,top=50,resizable=no');	
}
</script>
</body>
</html>