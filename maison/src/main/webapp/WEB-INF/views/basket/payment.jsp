...
<%@ page
	import="com.kh.maison.common.crypto.AES256Util,com.kh.maison.member.model.vo.Member"%>
					...
					<div class="checkout-address">
						...
						<form id="orderFrm" name="orderFrm">
							<div class="row">
								...
								<div class="col-md-6 mb-3">
									<label for="firstName">핸드폰번호 *</label> <input type="text"
										class="form-control" id="firstName" name="orPhone"
										value="<%=dPhone%>" placeholder="'-'없이 번호만 입력하세요" required>
									<div class="invalid-feedback">Valid first name is
										required.</div>
								</div>
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="orZipcode"
									value="<%=dZipcode%>" name="orZipcode" placeholder="우편번호"
									required>

							</div>
							<div class="mb-3">
								<label for="address">주소 *</label> <input type="text"
									class="form-control" name="orAddress" id="orAddress"
									value="<%=dAddress%>" placeholder="도로명주소" required>
							...
							<div class="shipping-method-box">
								...
								<div class="mb-4">
									<div class="custom-control custom-radio">
										...
										<label class="custom-control-label" for="shippingOption1">기본배송</label>
						...
						<div class="col-md-12 col-lg-12">
							<div class="order-box">
								...
								<div class="d-flex">
									...
									<div class="ml-auto font-weight-bold">
										...
										<input type="hidden" name="mileage"
											value="${loginMember.meileage }" id="mileage">
								...
								<div class="d-flex">
									...
									<div class="ml-auto font-weight-bold">
										<fmt:parseNumber integerOnly="true" value="${sum/10 }" />
										원 예정
									</div>
									<input type="hidden" name="stackMile"
										value="<fmt:parseNumber integerOnly="true" value="${sum/10 }"/>">
								</div>
