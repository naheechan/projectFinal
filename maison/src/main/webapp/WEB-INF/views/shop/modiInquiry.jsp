...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param name="title" value="문의수정"/>
</jsp:include>
<jsp:include page="/WEB-INF/views/common/menuTitle.jsp">
	<jsp:param name="menuTitle" value="문의수정"/>
</jsp:include>
<style>
	#data-div{
			...
			<div id="data-div">
				...
				<div class="form-group required">
					...
					<div class="form-group required">
						...
						<textarea cols="100%" rows="10"  id="piContent" class="form-control" name="piContent" required>${ pdiOne.piContent }</textarea>
					</div>
					<input type="hidden" name="pirContent" id="pirContent" value="${ reply.pirContent }">
					</div>
				</div>
			<div id="info-div">
				■ 개인정보의 수집·이용 목적
